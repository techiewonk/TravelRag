...
⚠️ _**Note:** Ollama support in the Investment Advisory AI Platform is experimental and may not work as expected. The instructions below have been tested using Docker Desktop on a MacBook Pro. Please file an issue for any challenges you encounter._
